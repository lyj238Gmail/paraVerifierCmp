...
let n_NI_InvAck_exists14 =
  ...
  let params = [paramdef "pp" "NODE"; paramdef "src" "NODE"] in
  let formula = (andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; arr [("InvMsg", [paramref "src"])]; global "Cmd"])) (const _INV_InvAck)); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _True))]); (eqn (var (record [global "Sta"; global "Dir"; arr [("InvSet", [paramref "src"])]])) (const _True))]); (neg (eqn (param (paramref "pp")) (param (paramref "src"))))]); (eqn (var (record [global "Sta"; global "Dir"; arr [("InvSet", [paramref "pp"])]])) (const _True))]) in
...
let n_NI_Local_GetX_Nak49 =
  ...
  let params = [paramdef "src" "NODE"] in
  let formula = (andList [(andList [(eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "Cmd"])) (const _UNI_GetX)); (eqn (var (record [global "Sta"; arr [("UniMsg", [paramref "src"])]; global "HomeProc"])) (const _True))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _True))]) in
...
let n_PI_Remote_GetX78 =
  let name = "n_PI_Remote_GetX78" in
  let params = [paramdef "src" "NODE"] in
...
let n_PI_Remote_Get82 =
  let name = "n_PI_Remote_Get82" in
  let params = [paramdef "src" "NODE"] in
  let formula = (andList [(eqn (var (record [global "Sta"; arr [("Proc", [paramref "src"])]; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; arr [("Proc", [paramref "src"])]; global "CacheState"])) (const _CACHE_I))]) in
...
let n_PI_Local_PutX69 =
  ...
  let params = [] in
  let formula = (andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_E))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _True))]) in
...
let n_PI_Local_PutX70 =
  ...
  let params = [] in
  let formula = (andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_E))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "HomeProc"; global "CacheState"]) (const _CACHE_I)); (assign (record [global "Sta"; global "Dir"; global "Local"]) (const (boolc false))); (assign (record [global "Sta"; global "Dir"; global "Dirty"]) (const (boolc false))); (assign (record [global "Sta"; global "MemData"]) (var (record [global "Sta"; global "HomeProc"; global "CacheData"])))]) in
  rule name params formula statement

let n_PI_Local_GetX_PutX72 =
  let name = "n_PI_Local_GetX_PutX72" in
  let params = [] in
  let formula = (andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_I))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "HeadVld"])) (const _False))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "Dir"; global "Local"]) (const (boolc true))); (assign (record [global "Sta"; global "Dir"; global "Dirty"]) (const (boolc true))); (assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_None)); (assign (record [global "Sta"; global "HomeProc"; global "InvMarked"]) (const (boolc false))); (assign (record [global "Sta"; global "HomeProc"; global "CacheState"]) (const _CACHE_E)); (assign (record [global "Sta"; global "HomeProc"; global "CacheData"]) (var (record [global "Sta"; global "MemData"])))]) in
  rule name params formula statement

let n_PI_Local_GetX_PutX73 =
  let name = "n_PI_Local_GetX_PutX73" in
  let params = [] in
  let formula = (andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_S))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "HeadVld"])) (const _False))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "Dir"; global "Local"]) (const (boolc true))); (assign (record [global "Sta"; global "Dir"; global "Dirty"]) (const (boolc true))); (assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_None)); (assign (record [global "Sta"; global "HomeProc"; global "InvMarked"]) (const (boolc false))); (assign (record [global "Sta"; global "HomeProc"; global "CacheState"]) (const _CACHE_E)); (assign (record [global "Sta"; global "HomeProc"; global "CacheData"]) (var (record [global "Sta"; global "MemData"])))]) in
  rule name params formula statement

let n_PI_Local_GetX_PutX_HeadVld74 =
  let name = "n_PI_Local_GetX_PutX_HeadVld74" in
  let params = [] in
  let formula = (andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_I))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "HeadVld"])) (const _True))]) in
...
let n_PI_Local_GetX_PutX_HeadVld75 =
  let name = "n_PI_Local_GetX_PutX_HeadVld75" in
  let params = [] in
  let formula = (andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_S))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "HeadVld"])) (const _True))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "Dir"; global "Local"]) (const (boolc true))); (assign (record [global "Sta"; global "Dir"; global "Dirty"]) (const (boolc true))); (assign (record [global "Sta"; global "Dir"; global "Pending"]) (const (boolc true))); (assign (record [global "Sta"; global "Dir"; global "HeadVld"]) (const (boolc false))); (assign (record [global "Sta"; global "Dir"; global "ShrVld"]) (const (boolc false))); (forStatement (parallel [(assign (record [global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])]]) (const (boolc false))); (ifelseStatement (orList [(andList [(eqn (var (record [global "Sta"; global "Dir"; global "ShrVld"])) (const _True)); (eqn (var (record [global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])]])) (const _True))]); (andList [(eqn (var (record [global "Sta"; global "Dir"; global "HeadPtr"])) (param (paramref "p"))); (eqn (var (record [global "Sta"; global "Dir"; global "HomeHeadPtr"])) (const _False))])]) (parallel [(assign (record [global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])]]) (const (boolc true))); (assign (record [global "Sta"; arr [("InvMsg", [paramref "p"])]; global "Cmd"]) (const _INV_Inv))]) (parallel [(assign (record [global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])]]) (const (boolc false))); (assign (record [global "Sta"; arr [("InvMsg", [paramref "p"])]; global "Cmd"]) (const _INV_None))]))]) [paramdef "p" "NODE"]); (assign (record [global "Sta"; global "Dir"; global "HomeShrSet"]) (const (boolc false))); (assign (record [global "Sta"; global "Dir"; global "HomeInvSet"]) (const (boolc false))); (assign (record [global "Sta"; global "HomeInvMsg"; global "Cmd"]) (const _INV_None)); (assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_None)); (assign (record [global "Sta"; global "HomeProc"; global "InvMarked"]) (const (boolc false))); (assign (record [global "Sta"; global "HomeProc"; global "CacheState"]) (const _CACHE_E)); (assign (record [global "Sta"; global "HomeProc"; global "CacheData"]) (var (record [global "Sta"; global "MemData"])))]) in
  rule name params formula statement

let n_PI_Local_GetX_GetX76 =
  let name = "n_PI_Local_GetX_GetX76" in
  let params = [] in
...
let n_PI_Local_GetX_GetX77 =
  let name = "n_PI_Local_GetX_GetX77" in
  let params = [] in
  let formula = (andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_S))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _True))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_GetX)); (assign (record [global "Sta"; global "Dir"; global "Pending"]) (const (boolc true))); (assign (record [global "Sta"; global "HomeUniMsg"; global "Cmd"]) (const _UNI_GetX)); (assign (record [global "Sta"; global "HomeUniMsg"; global "Proc"]) (var (record [global "Sta"; global "Dir"; global "HeadPtr"]))); (assign (record [global "Sta"; global "HomeUniMsg"; global "HomeProc"]) (var (record [global "Sta"; global "Dir"; global "HomeHeadPtr"])))]) in
  rule name params formula statement

let n_PI_Local_Get_Put79 =
  let name = "n_PI_Local_Get_Put79" in
  let params = [] in
  let formula = (andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_I))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _False))]); (eqn (var (record [global "Sta"; global "HomeProc"; global "InvMarked"])) (const _True))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "Dir"; global "Local"]) (const (boolc true))); (assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_None)); (assign (record [global "Sta"; global "HomeProc"; global "InvMarked"]) (const (boolc false))); (assign (record [global "Sta"; global "HomeProc"; global "CacheState"]) (const _CACHE_I))]) in
  rule name params formula statement

let n_PI_Local_Get_Put80 =
  let name = "n_PI_Local_Get_Put80" in
  let params = [] in
  let formula = (andList [(andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_I))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _False))]); (eqn (var (record [global "Sta"; global "HomeProc"; global "InvMarked"])) (const _False))]) in
  let statement = (parallel [(assign (record [global "Sta"; global "Dir"; global "Local"]) (const (boolc true))); (assign (record [global "Sta"; global "HomeProc"; global "ProcCmd"]) (const _NODE_None)); (assign (record [global "Sta"; global "HomeProc"; global "CacheState"]) (const _CACHE_S)); (assign (record [global "Sta"; global "HomeProc"; global "CacheData"]) (var (record [global "Sta"; global "MemData"])))]) in
  rule name params formula statement

let n_PI_Local_Get_Get81 =
  let name = "n_PI_Local_Get_Get81" in
  let params = [] in
  let formula = (andList [(andList [(andList [(eqn (var (record [global "Sta"; global "HomeProc"; global "ProcCmd"])) (const _NODE_None)); (eqn (var (record [global "Sta"; global "HomeProc"; global "CacheState"])) (const _CACHE_I))]); (eqn (var (record [global "Sta"; global "Dir"; global "Pending"])) (const _False))]); (eqn (var (record [global "Sta"; global "Dir"; global "Dirty"])) (const _True))]) in
...
let preProcessAndProp p =
 ...
 (* let ()=print_endline name in
  ...
  |AndList(_) ->
   List.map ~f:(fun f ->Prop(name,params,f)) ( negDisjI2Implication (Neg(formula)))
...
let main () =  
  ...
  let ()=print_endline "begin-----------/n" in
  let paraRef= paramfix "i" "NODE" (Intc(3)) in
  let dparaDef=paramdef "data" "DATA"  in
  let pair=("n_Store_Home83",[dparaDef]) in
  let pair1=("n_Store84",[dparaDef]) in
