theory ABS_flashWithoutABS_1TestError
  imports CMP
begin
...
definition n_NI_Remote_Get_Naks::" nat\<Rightarrow>rule set" where 
  "n_NI_Remote_Get_Naks N== twoParamCons N n_NI_Remote_Get_Nak" (*(oneParamCons N  n_NI_Remote_Get_Nak"*)
...
definition n_Store_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_Store_abs_abs  src dst\<equiv>
...
(\<forall>\<^sub>fj. \<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Proc'')) =\<^sub>f  (Const NODE_2) ) M
...
definition n_Store_Home_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_Store_Home_abs_abs  src dst\<equiv>
(IVar (Ident ''Sta.HomeProc.CacheState''))  =\<^sub>f (Const CACHE_E) 
   \<triangleright>
(assign ((Ident ''Sta.HomeProc.CacheData''), (IVar (Ident ''['DATA_1']'') )))||
(assign ((Ident ''Sta.CurrData''), (IVar (Ident ''['DATA_1']'') )))||
(assign ((Ident ''Sta.LastWrVld''), (Const true )))||
(assign ((Ident ''Sta.LastWrPtr''), (IVar (Ident '' Other'') )))"

definition n_PI_Remote_Get_abs_abs::"nat \<Rightarrow> rule" where [simp]:
"n_PI_Remote_Get_abs_abs  src\<equiv>
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) 
   \<triangleright>
(assign ((Ident ''Sta.HomeUniMsg.HomeProc''), (Const true )))"

definition n_PI_Remote_Get_Home_abs_abs::"nat \<Rightarrow> rule" where [simp]:
"n_PI_Remote_Get_Home_abs_abs  src\<equiv>
(IVar (Ident ''Sta.HomeProc.ProcCmd''))  =\<^sub>f (Const NODE_None)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeProc.CacheState''))  =\<^sub>f (Const CACHE_I) 
...
definition n_PI_Remote_GetX_Home_abs_abs::"nat \<Rightarrow> rule" where [simp]:
"n_PI_Remote_GetX_Home_abs_abs  src\<equiv>
(IVar (Ident ''Sta.HomeProc.ProcCmd''))  =\<^sub>f (Const NODE_None)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeProc.CacheState''))  =\<^sub>f (Const CACHE_I) 
...
definition n_PI_Remote_PutX_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_PI_Remote_PutX_abs_abs  src dst\<equiv>
(IVar (Ident ''Sta.Dir.HeadVld''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb)  \<and>\<^sub>f
(\<forall>\<^sub>fj. \<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Proc'')) =\<^sub>f  (Const NODE_2) ) M
...
definition n_NI_Nak_Home_abs_abs::"nat \<Rightarrow> rule" where [simp]:
"n_NI_Nak_Home_abs_abs  src\<equiv>
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_Nak) 
   \<triangleright>
(assign ((Ident ''Sta.HomeUniMsg.Cmd''), (Const UNI_None )))||
(assign ((Ident ''Sta.HomeProc.ProcCmd''), (Const NODE_None )))||
...
definition n_NI_Local_Get_Get_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Local_Get_Get_abs_abs  src dst\<equiv>
IVar (Ident ''Sta.Dir.Pending '') =\<^sub>f  (Const false) \<and>\<^sub>f
IVar (Ident ''
...
"n_NI_Remote_Get_Nak_abs_abs  src dst\<equiv>
...
(assign ((Ident ''Sta.NakcMsg.Cmd''), (Const NAKC_Nakc )))||
(assign ((Ident ''Sta.FwdCmd''), (Const UNI_None )))||
(assign ((Ident ''Sta.FwdSrc''), (Const NODE_1 )))"

definition n_NI_Remote_Get_Nak_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_Get_Nak_abs_abs_abs  src dst\<equiv>
...
"n_NI_Remote_Get_Nak_Home_abs_abs  src dst\<equiv>
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_Get)  \<and>\<^sub>f
...
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) 
   ...
   \<triangleright>
(assign ((Ident ''Sta.HomeUniMsg.Cmd''), (Const UNI_Nak )))||
(assign ((Ident ''Sta.HomeUniMsg.Proc''), (Const NODE_2 )))||
(assign ((Ident ''Sta.NakcMsg.Cmd''), (Const NAKC_Nakc )))||
(assign ((Ident ''Sta.FwdCmd''), (Const UNI_None )))||
(assign ((Ident ''Sta.FwdSrc''), (IVar (Ident '' Other'') )))"
...
definition n_NI_Remote_Get_Nak_Home_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_Get_Nak_Home_abs_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_Get)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const (index (M+1)))  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) 
...
"n_NI_Remote_Get_Put_abs_abs  src dst\<equiv>
...
\<not>\<^sub>f (IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E) 
...
definition n_NI_Remote_Get_Put_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_Get_Put_abs_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.WbMsg.Cmd'')) =\<^sub>f  (Const WB_Wb)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Local''))  =\<^sub>f (Const false)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.ShrVld''))  =\<^sub>f (Const false)  \<and>\<^sub>f
(\<forall>\<^sub>fj. \<not>\<^sub>f (IVar (Para (''Sta.UniMsg.Cmd'') j)) =\<^sub>f  (Const UNI_PutX) ) M \<and>\<^sub>f
(IVar (Para (''Sta.Dir.ShrSet'') j)) =\<^sub>f  (Const false)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E) 
...
"n_NI_Remote_Get_Put_Home_abs_abs  src dst\<equiv>
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_Get)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const NODE_2)  \<and>\<^sub>f
(IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
...
(assign ((Ident ''Sta.HomeUniMsg.Cmd''), (Const UNI_Put )))||
(assign ((Ident ''Sta.HomeUniMsg.Proc''), (Const NODE_2 )))||
(assign ((Ident ''Sta.HomeUniMsg.Data''), (IVar (Para (''Sta.Proc.CacheData '') j))))||
(assign ((Ident ''Sta.FwdCmd''), (Const UNI_None )))||
(assign ((Ident ''Sta.FwdSrc''), (IVar (Ident '' Other'') )))"
...
definition n_NI_Remote_Get_Put_Home_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_Get_Put_Home_abs_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_Get)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
...
definition n_NI_Local_GetX_GetX_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Local_GetX_GetX_abs_abs  src dst\<equiv>
IVar (Ident ''Sta.Dir.Pending '') =\<^sub>f  (Const false) \<and>\<^sub>f
IVar (Ident ''
	Sta.Dir.Dirty '') =\<^sub>f  (Const true) \<and>\<^sub>f
IVar (Ident ''Sta.Dir.Local '') =\<^sub>f  (Const false) \<and>\<^sub>f
...
"n_NI_Remote_GetX_Nak_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) 
...
definition n_NI_Remote_GetX_Nak_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_GetX_Nak_abs_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) 
...
"n_NI_Remote_GetX_Nak_Home_abs_abs  src dst\<equiv>
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_GetX)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const NODE_2)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) 
...
definition n_NI_Remote_GetX_Nak_Home_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_GetX_Nak_Home_abs_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_GetX)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const (index (M+1)))  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) 
...
"n_NI_Remote_GetX_PutX_abs_abs  src dst\<equiv>
(IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.WbMsg.Cmd'')) =\<^sub>f  (Const WB_Wb)  \<and>\<^sub>f
...
(assign (Para (''Sta.UniMsg.Proc'') j, (IVar (Ident '' Other'') )))||
(assign ((Ident ''Sta.ShWbMsg.Cmd''), (Const SHWB_FAck )))||
(assign ((Ident ''Sta.ShWbMsg.Proc''), (Const NODE_1 )))||
(assign ((Ident ''Sta.FwdCmd''), (Const UNI_None )))||
(assign ((Ident ''Sta.FwdSrc''), (Const NODE_1 )))"

definition n_NI_Remote_GetX_PutX_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_GetX_PutX_abs_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.WbMsg.Cmd'')) =\<^sub>f  (Const WB_Wb)  \<and>\<^sub>f
...
"n_NI_Remote_GetX_PutX_Home_abs_abs  src dst\<equiv>
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_GetX)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const NODE_2)  \<and>\<^sub>f
(IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
...
definition n_NI_Remote_GetX_PutX_Home_abs_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_Remote_GetX_PutX_Home_abs_abs_abs  src dst\<equiv>
\<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_GetX)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
...
definition n_NI_InvAck_abs_abs::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_NI_InvAck_abs_abs  src dst\<equiv>
IVar (Ident ''
...
definition n_NI_Replace_abs_abs::"nat \<Rightarrow> rule" where [simp]:
"n_NI_Replace_abs_abs  src\<equiv>
(IVar (Ident ''Sta.HomeRpMsg.Cmd''))  =\<^sub>f (Const RP_Replace) 
   \<triangleright>
(assign ((Ident ''Sta.HomeRpMsg.Cmd''), (Const RP_None )))||
(assign ((Ident ''Sta.Dir.HomeShrSet''), (Const false )))||
...
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb) ,
 ...
 (\<lambda>j. \<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Proc'')) =\<^sub>f  (Const NODE_2) ))"
...
definition pair3:: "((nat\<Rightarrow>formula)\<times>(nat\<Rightarrow>formula))" where [simp]:
 "pair3 ==(%i. \<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.WbMsg.Cmd'')) =\<^sub>f  (Const WB_Wb)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Local''))  =\<^sub>f (Const false)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.ShrVld''))  =\<^sub>f (Const false) ,
 ...
 (\<lambda>j. \<not>\<^sub>f (IVar (Para (''Sta.UniMsg.Cmd'') j)) =\<^sub>f  (Const UNI_PutX)  \<and>\<^sub>f
(IVar (Para (''Sta.Dir.ShrSet'') j)) =\<^sub>f  (Const false)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E) ))"

definition pair4:: "((nat\<Rightarrow>formula)\<times>(nat\<Rightarrow>formula))" where [simp]:
 "pair4 ==(%i. \<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_Get)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.WbMsg.Cmd'')) =\<^sub>f  (Const WB_Wb)  \<and>\<^sub>f
...
definition pair5:: "((nat\<Rightarrow>formula)\<times>(nat\<Rightarrow>formula))" where [simp]:
 "pair5 ==(%i. \<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Cmd'')) =\<^sub>f  (Const SHWB_ShWb)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.WbMsg.Cmd'')) =\<^sub>f  (Const WB_Wb)  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Local''))  =\<^sub>f (Const false)  \<and>\<^sub>f
...
definition pair6:: "((nat\<Rightarrow>formula)\<times>(nat\<Rightarrow>formula))" where [simp]:
 "pair6 ==(%i. \<not>\<^sub>f (IVar (Ident ''Other'')) =\<^sub>f  (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Cmd''))  =\<^sub>f (Const UNI_GetX)  \<and>\<^sub>f
(IVar (Ident ''Sta.HomeUniMsg.Proc''))  =\<^sub>f (Const (index (M+1)))  \<and>\<^sub>f
(IVar (Ident ''Sta.Dir.Dirty''))  =\<^sub>f (Const true)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Ident ''Sta.WbMsg.Cmd'')) =\<^sub>f  (Const WB_Wb)  \<and>\<^sub>f
...
\<not>\<^sub>f (IVar (Ident ''Sta.ShWbMsg.Proc'')) =\<^sub>f  (Const NODE_2)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Para (''Sta.Proc.CacheState'') j)) =\<^sub>f  (Const CACHE_E)  \<and>\<^sub>f
\<not>\<^sub>f (IVar (Para (''Sta.UniMsg.Cmd'') j)) =\<^sub>f  (Const UNI_PutX) ))"
...
(\<forall>i. i \<le> N \<longrightarrow>
 s (Para ''Sta.UniMsg_Cmd'' i) = UNI_Get \<or>  s (Para ''Sta.UniMsg_Cmd'' i) = UNI_GetX \<or>  s (Para ''Sta.UniMsg_Cmd'' i) = UNI_PutX)"
...
UNI_Get_def UNI_GetX_def UNI_PutX_def 
  by (metis  assms getValueType.simps(1) isEnumVal_def typeOf_def) 
