...
let g = (andList [(eqn (IVar (Para (''Chan3.Cmd'') i)) (Const InvAck)) , (neg (eqn (IVar (Ident ''CurCmd'')) (Const Empty))) , (eqn (IVar (Ident ''ExGntd'')) (Const true)) ])in
...
let g = (andList [(eqn (IVar (Para (''Chan3.Cmd'') i)) (Const InvAck)) , (neg (eqn (IVar (Ident ''CurCmd'')) (Const Empty))) , (neg (eqn (IVar (Ident ''ExGntd'')) (Const true))) ])in
...
let g = (andList [(eqn (IVar (Para (''Chan2.Cmd'') i)) (Const Inv)) , (eqn (IVar (Para (''Chan3.Cmd'') i)) (Const Empty)) , (neg (eqn (IVar (Para (''Cache.State'') i)) (Const E))) ])in
...
let g = (andList [(eqn (IVar (Ident ''CurCmd'')) (Const Empty)) ,
 (eqn (IVar (Para (''Chan1.Cmd'') i)) (Const ReqE)) ])in
let s = (parallelList [(assign ((Ident ''CurCmd''), (Const ReqE))), 
(assign ((Ident ''CurPtr''), (Const (index i)))), 
(assign (Para (''Chan1.Cmd'') i, (Const Empty))),
 (parallelList 
(map  (\<lambda>j. assign ((  Para (''InvSet'') j, (IVar (Para (''ShrSet'') j))) )) (down N)))]) 
in
guard g s"
...
let s = (parallelList [(assign ((Ident ''CurCmd''), (Const ReqS))), (assign ((Ident ''CurPtr''), (Const (index i)))), (assign (Para (''Chan1.Cmd'') i, (Const Empty))), (forallSent (down N) (\<lambda>j. (eqn (IVar (Para (''InvSet'') j)) (IVar (Para (''ShrSet'') j))) ))]) in
guard g s"
...
"initSpec0 N \<equiv>(andList (map  
 (\<lambda>i. (eqn (IVar (Para (''Chan1.Cmd'') i)) (Const Empty)) )
(down N)))"
